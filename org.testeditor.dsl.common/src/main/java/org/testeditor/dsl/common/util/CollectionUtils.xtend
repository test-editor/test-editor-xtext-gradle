...
class CollectionUtils {
	 ...
	 */
	def <A, B, C> Iterable<Pair<C, A>> filterValue(Iterable<Pair<C, B>> unfiltered, Class<A> clazz) {
	 ...
	 */
	def <A, B, C> Iterable<Pair<B, A>> filterKey(Iterable<Pair<C, A>> unfiltered, Class<B> clazz) {
	 ...
	 */
	def <A, B> Map<A, B> filterKey(Map<A, B> unfiltered, Class<? extends A> clazz) {
	 ...
	 */
	def Iterable<?> filterByTypes(Iterable<?> unfiltered, Class<?> ... types) {
	 ...
	 */
	def <A, B> Iterable<Pair<A,B>> filterValuesNull(Iterable<Pair<A,B>> unfiltered) {
	 ...
	 */
	def <T> Iterable<T> butLast(Iterable<T> includingLast) {
	 ...
	 */
	def <A> int indexOfFirst(Iterable <A> iterable, (A)=>Boolean predicate) {
	 ...
	 */
	def <A> int indexOfFirst(Iterable <A> iterable, A actual) {
	 ...
	 */
	def <K,V> Map<K,V> mergeOverwriting(Iterable<Map<K,V>> mapList) {
